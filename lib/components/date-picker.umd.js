...
var helpers_mergeEvents = function mergeEvents() {
  var result = {};
...
var helpers_mixinOptionalProps = function mixinOptionalProps(source, target, props) {
  ...
  props.forEach(function (p) {
    ...
    if (Object.prototype.hasOwnProperty.call(source, name)) {
      ...
      target[name] = mixin && isObject(value) ? _objectSpread2(_objectSpread2({}, mixin), value) : value;
      assigned.push(name);
    }
  });
  return {
...
toPairs_default()(locales_locales).forEach(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      id = _ref2[0],
      _ref2$ = _ref2[1],
      dow = _ref2$.dow,
...
var theme_Theme = /*#__PURE__*/function () {
  ...
  _createClass(Theme, [{
    ...
    value: function normalizeAttr(_ref) {
      ...
      toPairs_default()(root).forEach(function (_ref2) {
        ...
        if (!_has(root, "".concat(targetType, ".color"))) {
          set_default()(root, "".concat(targetType, ".color"), targetColor);
        }
      });
      return root;
    }
    ...
    value: function normalizeHighlight(config) {
      ...
      toPairs_default()(highlight).forEach(function (_ref4) {
        var _ref5 = _slicedToArray(_ref4, 2),
            _ = _ref5[0],
            targetConfig = _ref5[1];

        var c = defaults_default()(targetConfig, {
          isDark: _this.isDark,
          color: _this.color
        });
    ...
    value: function normalizeNonHighlight(type, config, styleFn) {
      ...
      toPairs_default()(attr).forEach(function (_ref10) {
...
var locale_Locale = /*#__PURE__*/function () {
  ...
  _createClass(Locale, [{
    ...
    value: function format(date, mask, timezone) {
      ...
      mask = helpers_arrayHasItems(mask) && mask[0] || isString_default()(mask) && mask || 'YYYY-MM-DD';
    ...
    value: function parse(dateStr, mask, timezone) {
      ...
      var masks = helpers_arrayHasItems(mask) && mask || [isString_default()(mask) && mask || 'YYYY-MM-DD'];
...
var dateInfo_DateInfo = /*#__PURE__*/function () {
  function DateInfo(config) {
    ...
    if (this.isRange) {
      ...
      if (config.on) {
        var or = (isArrayLikeObject_default()(config.on) ? config.on : [config.on]).map(function (o) {
...
/* harmony default export */ var CalendarDayvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var contentLayer = function contentLayer() {
      return _this.safeScopedSlot('day-content', {
        ...
        attrs: _objectSpread2({}, _this.dayContentProps),
  ...
  methods: {
    ...
    processPopover: function processPopover(attribute, _ref8) {
      ...
      if (!popover) return;
      var resolvedPopover = defaults_default()({
        key: key,
    ...
    refreshPopovers: function refreshPopovers() {
      ...
      this.dayContentEvents = helpers_mergeEvents({
        click: this.click,
  ...
  render: function render(h) {
    ...
    var weeks = h(Grid, {
      ...
      return h(CalendarDay, {
        attrs: _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
          day: day
        }),
    ...
    value: function refresh(attrs, reset) {
      ...
      if (helpers_arrayHasItems(attrs)) {
        attrs.forEach(function (attr, i) {
          ...
          var hashcode = helpers_hash(JSON.stringify(attr));
          ...
          if (!reset && exAttr && exAttr.hashcode === hashcode) {
            ...
            exAttr = new attribute_Attribute(_objectSpread2({
              key: key,
              order: order,
              hashcode: hashcode
  ...
  render: function render(h) {
    ...
    var getContainerGrid = function getContainerGrid() {
      return h('div', {
        ...
        attrs: _objectSpread2({}, _this.$attrs),
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                _context3.next = 5;
                return _this5.refreshPages(_objectSpread2(_objectSpread2({}, opts), {}, {
                  page: page
                }));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                } else if (pageIsBeforePage(page, _this6.firstPage)) {
                  fromPage = _this6.getTargetPageRange(page, -1).fromPage;
                } else if (pageIsAfterPage(page, _this6.lastPage)) {
                  fromPage = _this6.getTargetPageRange(page, 1).fromPage;
                } // Move to new fromPage if it's different from the current one


                if (!(fromPage && !pageIsEqualToPage(fromPage, _this6.pages[0]))) {
                  _context4.next = 7;
                  break;
                }

                _context4.next = 7;
                return _this6.refreshPages(_objectSpread2(_objectSpread2({}, opts), {}, {
                  position: 1,
                  page: fromPage
                }));
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 11:
                ...
                if (pageIsAfterPage(toPage, lastPage)) {
                  page = addPages(toPage, -(_this7.pages.length - 1));
                ...
                _context5.next = 17;
                return _this7.refreshPages(_objectSpread2(_objectSpread2({}, opts), {}, {
                  page: page
                }));
    ...
    getTargetPageRange: function getTargetPageRange(page, position) {
      ...
      if (pageIsValid(page)) {
        ...
        if (!pageIsValid(fromPage)) {
          ...
          var _toPage = this.toPage || pageForDate(this.normalizeDate(this.toPage));
              ...
              case 0:
                ...
                return _context6.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  for (var i = 0; i < _this8.count; i++) {
                    pages.push(_this8.buildPage(addPages(fromPage, i), ignoreCache));
  ...
  methods: {
    ...
    updateValue: function updateValue() {
      ...
      this.protected(function () {
        ...
        _this3.$emit('input', _objectSpread2(_objectSpread2({}, _this3.value), {}, {
          hours: hours,
...
/* harmony default export */ var DatePickervue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var calendar = function calendar() {
      return h(Calendar, {
        ...
        scopedSlots: _objectSpread2(_objectSpread2({}, _this.$scopedSlots), {}, {
  ...
  computed: {
    ...
    attributes_: function attributes_() {
      var attrs = isArrayLikeObject_default()(this.attributes) ? _toConsumableArray(this.attributes) : [];
  ...
  methods: {
    initDateConfig: function initDateConfig() {
      ...
      if (this.isRange) {
        config = {
          start: _objectSpread2(_objectSpread2({
            timezone: timezone
          }, _rangeConfig.start), this.modelConfig.start || this.modelConfig),
          end: _objectSpread2(_objectSpread2({
            timezone: timezone
    ...
    normalizeValue: function normalizeValue(value, config, patch, isDragging) {
      ...
      if (this.isRange) {
        ...
        if (patch !== PATCH_DATE_TIME) {
          var startParts = _objectSpread2(_objectSpread2({}, this.dateParts[0]), pick_default()(this.getDateParts(_result.start), patchKeys));

          _result.start = this.getDateFromParts(startParts);

          var endParts = _objectSpread2(_objectSpread2({}, this.dateParts[1]), pick_default()(this.getDateParts(_result.end), patchKeys));
      ...
      result = _objectSpread2(_objectSpread2({}, this.dateParts[0]), pick_default()(this.getDateParts(result), patchKeys));
    ...
    showPopover: function showPopover() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      popovers_showPopover(_objectSpread2(_objectSpread2({
        ref: this.$el
      }, opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
    ...
    hidePopover: function hidePopover() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      popovers_hidePopover(_objectSpread2(_objectSpread2({}, opts), {}, {
        id: this.datePickerPopoverId
      }));
    },
    togglePopover: function togglePopover(opts) {
      popovers_togglePopover(_objectSpread2(_objectSpread2({
        ref: this.$el
      }, opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
